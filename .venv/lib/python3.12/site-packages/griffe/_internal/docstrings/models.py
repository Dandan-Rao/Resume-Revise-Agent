...
class DocstringSectionTypeParameters(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringTypeParameter], title: str | None = None
    ) -> None:
        """Initialize the section.
...
class DocstringSectionExamples(DocstringSection):
    ...
    def __init__(
        ...
        value: list[
            tuple[
                Literal[DocstringSectionKind.text, DocstringSectionKind.examples], str
            ]
        ],
        title: str | None = None,
    ) -> None:
...
class DocstringSectionTypeAliases(DocstringSection):
    ...
    def __init__(
        self, value: list[DocstringTypeAlias], title: str | None = None
    ) -> None:
        """Initialize the section.

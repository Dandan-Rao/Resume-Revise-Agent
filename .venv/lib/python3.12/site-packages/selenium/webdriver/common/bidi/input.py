...
class PointerParameters:
    ...
    def __post_init__(self):
        if self.pointer_type not in PointerType.VALID_TYPES:
            raise ValueError(
                f"Invalid pointer type: {self.pointer_type}. Must be one of {PointerType.VALID_TYPES}"
            )
...
class KeySourceActions:
    ...
    id: str = ""
    actions: list[Union[PauseAction, KeyDownAction, KeyUpAction]] = field(
...
class PointerSourceActions:
    ...
    actions: list[
        Union[PauseAction, PointerDownAction, PointerUpAction, PointerMoveAction]
